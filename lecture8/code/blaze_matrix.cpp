...
int main()
{
    ...
    //   (  0  2 )
    //   ( -1  0 )
    StaticMatrix<int, 3, 2, columnMajor> B{{3, -1}, {0, 2}, {-1, 0}};

    // Performing a dense matrix/dense matrix mtiplication
    DynamicMatrix<int> C = A * B;

    // Printing the resting matrix
    std::cout << "C =\n"
              << C << "\n";
}
